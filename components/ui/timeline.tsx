...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
    ...
    const { scrollYProgress } = useScroll({
        target: containerRef,
        offset: ["start start", "end end"], // Smoother transitions
    });
        ...
        >
            <div className="max-w-7xl mx-auto py-12 px-4 md:px-8 lg:px-10">
                ...
                <p className="text-neutral-700 dark:text-neutral-300 text-md md:text-base max-w-sm">
                    I&apos;ve expreince both side Frontend and Backend with varius technolagy.
                </p>
            </div>
            ...
            <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
                ...
                >
                    <motion.div
                        ...
                        className="absolute inset-x-0 top-0 w-[2px] bg-gradient-to-t from-via-[rgb(99,65,51)]  via-[#f78764]  to-transparent from-[0%] via-[10%] rounded-full"
                    />
                </div>
            </div>
        </div>
